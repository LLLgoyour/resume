...
#let runReader(mode) = {
  ...
  let edu = {
    let hs-courses = (
      ...
      ([], [History: Decision 2024], [2024美国大选研究]),
    )
...
let achievements = {
  ...
  let skills = {
    ...
    let PyJava = {
      ...
      translate(
        en: [- Java/Python: *6 years of experience*, familiar with #before-swing, basic to advanced algorithms, number theory and group theory for competitive coding.],
        zh: [- Java/Python：*6 年开发经验*，熟悉 #before-swing 以及在算法竞赛中会应用到的初级到高级算法与数论和图论。]
      )
    }
    let webDev = translate(
      en: [- Web Development: *3 years of experience*, familiar with mainstream frameworks and languages including Vue.JS.],
      zh: [- 网页开发：*3 年开发经验*，熟悉主流框架与语言如Vue.JS。]
    )
    let office-tools = translate(
      en: [- Office Tools: *3 years of experience*, familiar with Microsoft Office, Google Docs, and other office tools.],
  ...
  [#link("mailto:xchdai@gmail.com")[xchdai\@gmail.com] $dot.c$ #iconlink("https://lllgoyour.com") $dot.c$ #iconlink("https://github.com/LLLgoyour", icon: "github")]
